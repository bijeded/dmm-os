...
export type EstadoIngreso = 'pendiente' | 'pagado' | 'cancelado' | 'incobrable'
export type EstadoCosto = 'pendiente' | 'pagado' | 'cancelado'
...
export interface FilaIngreso {
  ...
  estadoFacturacion: 'por_facturar' | 'facturado' | null
